...
{	
	...
	public function payment_confirm_lote_pay(){
	...
	public function payment_confirm_lote_fact(){
		...
		if($this->db->trans_status() === TRUE){
			$this->db->trans_commit();
			return array('status' => TRUE,'msg'=>'<b>El traslado ha sido facturado correctamente.</b>','fecha'=>$fecha,'folio'=>$this->folio);
		}
		else{
			$this->db->trans_rollback();
			return array('status' => FALSE,'msg'=>'ha ocurrido un error inesperado intentelo de nuevo más tarde.');	
