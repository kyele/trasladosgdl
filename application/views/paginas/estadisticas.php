                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                           ...
                           <ol class="breadcrumb">
                                ...
                                <li class="active">Traslados(Pagados/Pendientes)</li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="portlet portlet-default">
            ...
            <div class="portlet-body">
                <?php echo validation_errors();?> 
                 ...
                 <?php $attributes = array('id' => 'myform_estadisticas_traslados'); echo form_open(base_url().'estadisticas.html',$attributes); ?>
                    <div class="row">
