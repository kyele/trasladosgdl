...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "z _START_ to _END_ of _TOTAL_ entries",
...
$.extend( true, $.fn.dataTable.defaults, {
	...
	"language": {
		"lengthMenu": "Mostrar _MENU_ Registros Por Página",
            "zeroRecords": "No se entontraron Resultados",
...
$.extend( $.fn.dataTableExt.oPagination, {
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).append(
				'<ul class="pagination">'+
					'<li class="Anterior disabled"><a href="#">← '+oLang.sPrevious+'</a></li>'+
					'<li class="Siguiente disabled"><a href="#">'+oLang.sNext+' → </a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
